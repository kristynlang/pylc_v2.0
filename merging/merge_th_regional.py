...
mask_categories = {
'#000000':'Not categorized',
'#ff5500':'Broadleaf/Mixedwood forest',
'#005500':'Coniferous forest',
'#00aa00':'Herbaceous',
'#858585':'Rock',
'#aa0000':'Industrial/recreational',
'#aa00ff':'Riverine Wetland',
'#55007f':'Lacustrine Wetland',
'#00ffff':'Snow/Ice',
'#ff0000':'Regenerating Area',
}
...
def merge_classes(data):
    ...
    water_idx = np.isin(data, categories_merged[5])
    snowice_idx = np.isin(data, categories_merged[6])
    reg_idx = np.isin(data, categories_merged[7])
