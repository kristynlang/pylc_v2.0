...
#taggart-hodge fluvial categories and colors
mask_categories = {
'#000000':'Not categorized',
'#ffaa00':'Broadleaf/mixedwood forest',
'#005500':'Coniferous forest',
'#00aa7f':'River island',
'#00cb00':'Grassland Herbaceous',
'#7f8b87':'Sand/Gravel/Rock',
'#aa0000':'Industrial/recreational',
'#fff7cf':'Bare exposed bar',
'#00007f':'Floodplain',
'#aa5500':'Vegetated Bar',
'#0707ff':'Water',
'#00ffff':'Snow/Ice',
'#ff0004':'Regenerating Area',
}
...
[[0, 0, 0], #not categorized
 [255, 170, 0], #broadleaf/mixedwood
 [0, 85, 0], #conifer forest
 [0, 170, 127], #river island
 [0, 203, 0], #herbaceous
 [127, 139, 135], #sand/gravel/rock
 [170, 0, 0], #industrial/recreational
 [255, 247, 207], #bare exposed bar
 [0, 0, 127], #floodplain
 [170, 85, 0], #vegetated bar
 [7, 7, 255], #water
 [0, 255, 255], #snow/ice
 [255, 0, 4] #regenerating
 ])
 
# merged classes (th to lcc_a)
categories_merged = [
    np.array([0]), #not categorized
    np.array([1]), #broadleaf/mixed wood
    np.array([2,3]), #conifer forest
    np.array([4]), #herbaceous/shrub
    np.array([5,6,7]), #barren rock
    np.array([8,9]),#wetland
    np.array([10]), #water
    np.array([11]), #snow/ice 
    np.array([12]) #regenerating
]

# Merged classes
palette_merged = np.array(
[[0, 0, 0],
 [255, 165, 0],
 [34, 139, 34],
 [124, 252, 0],
